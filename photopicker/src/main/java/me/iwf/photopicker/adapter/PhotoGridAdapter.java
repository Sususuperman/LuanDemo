...
//        selectedPhotos = new ArrayList<>(orginalPhotos);
     ...
     * 添加选中照片
     */
    public void addSelectPhoto(Photo photo){
...
//            if(isEnable){
//                holder.vSelected.setEnabled(true);
//                holder.ivPhoto.setEnabled(true);
//                holder.vSelected.setImageResource(R.drawable.__picker_checkbox_enable);
//            }else{
//                holder.vSelected.setEnabled(false);
//                holder.ivPhoto.setEnabled(false);
//                holder.vSelected.setImageResource(R.drawable.__picker_checkbox_bg);

                holder.vSelected.setSelected(isChecked);
                holder.ivPhoto.setSelected(isChecked);
//            }
//            boolean isEnabled = isEnabled(photo);
//            holder.vSelected.setEnabled(isEnabled);
//            holder.ivPhoto.setEnabled(isEnabled);
            ...
            holder.vSelected.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    boolean isUpload = isUpload(photo);
                    if(isUpload){
                        Toast.makeText(view.getContext(),"图片已上传，不可选择！",Toast.LENGTH_SHORT).show();
                    }else{
                        int pos = holder.getAdapterPosition();

...
public class ImagePagerFragment extends Fragment {
  ...
  private ArrayList<Photo> longData;
  ...
  public void setPhotos(List<String> paths, int currentItem,ArrayList<Photo> longData) {
    this.paths.clear();
  ...
  public void runExitAnimation(final Runnable endAction) {
    ...
    ViewPropertyAnimator.animate(mViewPager)
        ...
        .setListener(new Animator.AnimatorListener() {
          ...
          @Override public void onAnimationRepeat(com.nineoldandroids.animation.Animator animation) {
          }
        });

...
public class PostRestPasswordTask extends ValidSourceTask {

    public PostRestPasswordTask(Context context) {
        super(context, null);
    }
    ...
    protected Map<String, Object> sendData(Map<String, Object> params) throws Exception {
        ...
        String content = HttpUtils.postString(HttpUrl.getServiceUrl(HttpUrl.RMS_APP_USER_EDITPASS),params);

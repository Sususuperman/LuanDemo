...
public class GetEventListTask extends BaseRequestTask {
    ...
    public GetEventListTask(Context context, int key) {
        super(context);
        this.key = key;
    }
    ...
    @Override
    public String url() {
        return HttpUrl.getUrl(HttpUrl.RMS_APP_EVENT_CREATE_APPLIST);
    }

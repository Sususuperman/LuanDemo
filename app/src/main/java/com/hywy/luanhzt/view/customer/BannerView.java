...
import com.hywy.luanhzt.adapter.BannerAdapter;
            ...
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.drawable.bg_button_normal);
...
//                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_point_select);
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.indicator_select);
                } else {
//                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_point);
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.indicator_no_select);
                }
            }
        }
    }

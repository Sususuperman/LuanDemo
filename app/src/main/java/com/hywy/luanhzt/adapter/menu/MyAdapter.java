package com.hywy.luanhzt.adapter.menu;
...
import com.hywy.luanhzt.drag.DragAdapterInterface;
...
public class MyAdapter extends BaseAdapter implements DragAdapterInterface {
	...
	public MyAdapter(MenuManageActivity context, App appContext, List<MenuEntity> datas) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //获取资源图片
        int drawableId = context.getResources().getIdentifier(bean.getIco(),"drawable", context.getPackageName());

package com.cs.upgrade.view;

/*
 * pb_padding	    背景与进度之间的内间距大小	dimension
    pb_bg_color	背景颜色	color
    pb_pb_color	进度颜色	color
    pb_max	        进度最大值	int
    pb_progress	默认进度值	int
 * Created by Superman on 2017/10/17.
 */
